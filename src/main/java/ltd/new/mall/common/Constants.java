...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "D:\\Projects\\GitProjects\\web_mall\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int INDEX_GOODS_NEW_NUMBER = 4;//首页新品数量
